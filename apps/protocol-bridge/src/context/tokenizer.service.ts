 ...
 *
 * Note: Claude uses a different tokenizer than GPT-4, but cl100k_base
 * provides a reasonable approximation. A correction factor is applied
...
export class TokenizerService implements OnModuleInit {
  ...
  /**
   * Count tokens in role/content message arrays
   */
  countMessageTokens(
    messages: Array<{
      role: string
